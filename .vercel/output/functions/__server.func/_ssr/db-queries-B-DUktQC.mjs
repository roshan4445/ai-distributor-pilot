import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-CrinQusP.mjs";
import { c as createServerFn, i as TSS_SERVER_FUNCTION } from "./esm-B50dUWcE.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/db-queries-B-DUktQC.js
...
var runCronAction = createServerFn({ method: "POST" }).validator((data) => data).handler(createSsrRpc("e439ec9d9e66247d12dd0c22009c6affdbfd695d8b1bbf061f8e8981af9ab510"));
...
var clearConversationAction = createServerFn({ method: "POST" }).validator((data) => data).handler(createSsrRpc("92ebcdec2baf99b61f9d65871c39a3f5b673c57e0973dba64de1f9e9701c0389"));
//#endregion
export { getConversationsList as a, getDealers as c, getInvoiceDetailsAction as d, getInvoices as f, updateOrderStatusAction as g, runCronAction as h, getAiDuesAnalysis as i, getDues as l, postMessage as m, clearConversationAction as n, getDashboardData as o, getOrders as p, createProductAction as r, getDealerById as s, askAiQuery as t, getInventory as u };
