...
import { d as getInvoiceDetailsAction, m as postMessage, n as clearConversationAction } from "./db-queries-D4xYwou2.mjs";
...
import { t as Route } from "./conversations-CUOXIJUP.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/conversations-Bilonhjs.js
						...
						pipelineStep >= 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: "Goal: Process Dealer Request"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "space-y-1.5 text-[11px] text-slate-400",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: pipelineStep >= 2 ? "text-success font-medium" : "text-slate-300 font-medium",
											children: [pipelineStep >= 2 ? "✓" : "○", " Validate Dealer Profile"]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: pipelineStep >= 2 ? "text-success font-medium" : "text-slate-300 font-medium",
											children: [pipelineStep >= 2 ? "✓" : "○", " Validate Product Catalog"]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: pipelineStep >= 4 ? "text-success font-medium" : "text-slate-300 font-medium",
											children: [pipelineStep >= 4 ? "✓" : "○", " Verify Safety Stock Limits"]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: pipelineStep >= 4 ? "text-success font-medium" : "text-slate-300 font-medium",
											children: [pipelineStep >= 4 ? "✓" : "○", " Create Order Entry"]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: pipelineStep >= 5 ? "text-success font-medium" : "text-slate-300 font-medium",
											children: [pipelineStep >= 5 ? "✓" : "○", " Auto-Generate Invoice"]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: pipelineStep >= 6 ? "text-success font-medium" : "text-slate-300 font-medium",
											children: [pipelineStep >= 6 ? "✓" : "○", " Reflect & Confirm Consistent"]
										})
									]
								})]
							})]
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MonitorRow, {
										label: "Tools Active",
										value: pipelineStep === 3 ? "createOrder()" : pipelineStep > 3 ? "createOrder() (Done)" : "None"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MonitorRow, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [msg.time, !isThinking && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CheckCheck, { className: "h-3 w-3 text-primary" })]
				})
			]
		})
	});
