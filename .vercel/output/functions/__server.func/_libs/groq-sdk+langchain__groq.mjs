import { C as ChatMessage, D as isSerializableSchema, E as toJsonSchema, F as isInteropZodSchema, P as getSchemaDescription, S as FunctionMessageChunk, T as ToolMessageChunk, _ as AIMessageChunk, a as BaseChatModel, c as createFunctionCallingParser, d as parseToolCall, f as ChatGenerationChunk, g as AIMessage, h as convertOpenAICompletionsStream, i as convertToOpenAITool, l as convertLangChainToolCallToOpenAI, m as getEnvironmentVariable, o as assembleStructuredOutputPipeline, s as createContentParser, u as makeInvalidToolCall, v as isAIMessage, w as ChatMessageChunk, x as HumanMessageChunk, y as SystemMessageChunk } from "./@langchain/core+[...].mjs";
//#region node_modules/@langchain/groq/dist/profiles.js
var PROFILES = {
	"llama3-70b-8192": {
		maxInputTokens: 8192,
		imageInputs: false,
...
//#endregion
//#region node_modules/@langchain/groq/dist/utils/groq-schema.js
/**
...
function makeNullable(schema) {
	...
	if (Array.isArray(schema.enum)) {
		...
		const nextType = Array.from(/* @__PURE__ */ new Set([...baseType, "null"]));
		return {
			...schema,
			type: nextType,
			enum: nextEnum
	...
	if (Array.isArray(schema.type)) return {
		...schema,
		type: Array.from(/* @__PURE__ */ new Set([...schema.type, "null"]))
	};
...
*/
var SUPPORTED_STRUCTURED_OUTPUT_METHODS = [
	"jsonSchema",
	"functionCalling",
	"jsonMode"
];
...
Groq.Files = Files;
//#endregion
//#region node_modules/@langchain/groq/dist/chat_models.js
/**
...
var ChatGroq = class extends BaseChatModel {
	...
	constructor(modelOrFields, fields) {
		...
		super(params);
		this._addVersion("@langchain/groq", "1.3.1");
	...
	async *_streamChatModelEvents(messages, options, _runManager) {
		...
		yield* convertOpenAICompletionsStream(abortableStream(response, options.signal), {
			streamUsage: true,
			provider: "groq"
		});
	}
